...
//for user input on terminal.

// int main() {
//     cout << "=== Water Bottle VENDING MACHINE ===" << endl;

//     int itemCount, itemPrice;
//     cout << "Enter initial item count: ";
//     cin >> itemCount;
//     cout << "Enter price of one item: Rs ";
//     cin >> itemPrice;
...
//             case 5: {
//                 int quantity;
//                 cout << "Enter number of items to refill: ";
//                 cin >> quantity;
//                 machine.refill(quantity);
//                 break;
//             }
//             case 0:
//                 cout << "Exiting Vending Machine. Goodbye!" << endl;
//                 break;
//             default:
