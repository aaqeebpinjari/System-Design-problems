...
//In this, likewise earlier we had account and major type and problem was with withdrawn, so classified entire set and restructure the entire daigram once again


/*this is used by fd only, since allowing to deposit money only, no room or method need to taken rid off like earlier*/
...
//withdrawabale account and it has been inherited by saving, current acc only and havig methods such as deposit, withdraw ...
