//Here we consider the real world scenario of amount
/*Defination: the child class inherting the base class and we substitute the 
child instead of base then it should work*/

// This rule is mostly broken by while designing the system


//Banking system- consisiting of saving and current acc
#include <iostream>
#include<vector>
using namespace std;
