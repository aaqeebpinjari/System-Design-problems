...
/*Exception Rule: A subclass should throw fewer or narrower exceptions (but not additional or broader exceptions) than the parent. C++ does not enforces this. Hence no compilation error.You should not throw broader or unexpected exceptions in a subclass that are not declared in the base class*/
...
//this is more boarder than the parents class
