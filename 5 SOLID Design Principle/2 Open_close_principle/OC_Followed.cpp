...
//Abstract class: consisting of pure virtual function, which are overriden by
//class who will be inherting it...
...
//Using abstraction as we are using abstract class and 
//using inheritance for the derived class and overriding function
